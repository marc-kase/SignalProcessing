...
//        show(d, "d = convolve(x, x)");
    ...
    private static void writeAbsData(Complex[] y) throws IOException {
        FileWriter writer = new FileWriter(new File("data/data.abs"));
        double[] y1 = new double[y.length];
        for (int i = 0; i < y.length; i++) {
            writer.write("" + y[i].abs() + "\n");
        }
        writer.close();
    }

    private static void writeReData(Complex[] y) throws IOException {
        FileWriter writer = new FileWriter(new File("data/data.re"));
        double[] y1 = new double[y.length];
    ...
    private static void writeImData(Complex[] y) throws IOException {
        FileWriter writer = new FileWriter(new File("/home/mark/Tmp/data.im"));
        double[] y1 = new double[y.length];
        System.out.println("Length: " + y.length);
        for (int i = 0; i < y.length; i++) {
            writer.write("" + y[i].im() + "\n");
